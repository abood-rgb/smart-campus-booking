 ...
 * 
 * OOP Principles:
 * ✅ Encapsulation: بيانات private مع getters/setters
 * ✅ Single Responsibility: تمثيل النشاط فقط
 */
public class Activity {
    ...
    public String toString() {
        ...
        return String.format(
            "ID: %s | Title: %s | Date: %s | Location: %s | Capacity: %d/%d | Available: %d",
            id, title, dateTime.format(formatter), location, 
            getRegisteredCount(), capacity, getAvailableSlots()
        );
    }
}
